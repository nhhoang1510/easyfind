...
const mockDB = {
  users: [],
  courts: [
    { id: 1, name: 'Sân Cầu Lông Cầu Giấy Sport',        address: '36 Trần Thái Tông, Dịch Vọng Hậu, Cầu Giấy, Hà Nội', district: 'Cầu Giấy', city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Cầu+Giấy+Sport+36+Trần+Thái+Tông' },
    { id: 2, name: 'Sân Cầu Lông Học Viện Báo Chí',      address: '361 Xuân Thủy, Dịch Vọng Hậu, Cầu Giấy, Hà Nội',     district: 'Cầu Giấy', city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Học+Viện+Báo+Chí+361+Xuân+Thủy' },
    { id: 3, name: 'Sân Cầu Lông Nhà Thi Đấu Cầu Giấy',  address: '35 Trần Quý Kiên, Dịch Vọng, Cầu Giấy, Hà Nội',      district: 'Cầu Giấy', city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Nhà+Thi+Đấu+Cầu+Giấy' },
    { id: 4, name: 'Sân Cầu Lông Khâm Thiên',           address: '12 Khâm Thiên, Văn Chương, Đống Đa, Hà Nội',          district: 'Đống Đa',  city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Khâm+Thiên+12+Khâm+Thiên' },
    { id: 5, name: 'Sân Cầu Lông Thủy Lợi Arena',       address: '175 Tây Sơn, Trung Liệt, Đống Đa, Hà Nội',           district: 'Đống Đa',  city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Thủy+Lợi+175+Tây+Sơn' },
    { id: 6, name: 'Sân Cầu Lông Viettel Giang Văn Minh', address: '1 Giang Văn Minh, Kim Mã, Ba Đình, Hà Nội',         district: 'Ba Đình',  city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Viettel+1+Giang+Văn+Minh' },
    { id: 7, name: 'Sân Cầu Lông Quần Ngựa',            address: '30 Văn Cao, Liễu Giai, Ba Đình, Hà Nội',              district: 'Ba Đình',  city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Quần+Ngựa+30+Văn+Cao' },
    { id: 8, name: 'Sân Cầu Lông Khuất Duy Tiến Center', address: '166 Khuất Duy Tiến, Nhân Chính, Thanh Xuân, Hà Nội',  district: 'Thanh Xuân', city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+166+Khuất+Duy+Tiến' },
    { id: 9, name: 'Sân Cầu Lông Mỹ Đình Arena',        address: '1 Đường Lê Đức Thọ, Mỹ Đình, Nam Từ Liêm, Hà Nội',   district: 'Nam Từ Liêm', city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Mỹ+Đình+Lê+Đức+Thọ' },
    { id: 10, name: 'Sân Cầu Lông Nhà Thi Đấu Hà Đông',  address: '182 Quang Trung, Hà Đông, Hà Nội',                    district: 'Hà Đông',  city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Nhà+Thi+Đấu+Hà+Đông' },
    { id: 11, name: 'Sân Cầu Lông Tây Hồ Complex',       address: '694 Lạc Long Quân, Nhật Tân, Tây Hồ, Hà Nội',        district: 'Tây Hồ',   city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+694+Lạc+Long+Quân' },
    { id: 12, name: 'Sân Cầu Lông Bách Khoa Arena',     address: '40 Tạ Quang Bửu, Bách Khoa, Hai Bà Trưng, Hà Nội',    district: 'Hai Bà Trưng', city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Bách+Khoa+Tạ+Quang+Bửu' },
    { id: 13, name: 'Sân Cầu Lông Long Biên Arena',      address: '5 Đức Giang, Đức Giang, Long Biên, Hà Nội',          district: 'Long Biên', city: 'Hà Nội', maps_url: 'https://maps.google.com/?q=Sân+Cầu+Lông+Long+Biên+5+Đức+Giang' },
  ],
  matches: [],
  participants: [],
  nextUserId: 1,
