...
const mockDB = {
  users: [],
  courts: [
    { id: 1, name: 'Sân Cầu Lông Viettel',        address: '1 Giang Văn Minh, Kim Mã',           district: 'Ba Đình',   city: 'Hà Nội'  },
    { id: 2, name: 'Sân Cầu Lông Khâm Thiên',     address: '12 Khâm Thiên',                       district: 'Đống Đa',   city: 'Hà Nội'  },
    { id: 3, name: 'Sân Cầu Lông Cầu Giấy Sport', address: '36 Trần Thái Tông',                   district: 'Cầu Giấy',  city: 'Hà Nội'  },
    { id: 4, name: 'Sân Cầu Lông Long Biên Arena', address: '5 Đức Giang',                        district: 'Long Biên', city: 'Hà Nội'  },
    { id: 5, name: 'Sân Kỳ Hòa',                  address: '1 Huyền Trân Công Chúa, Quận 1',     district: 'Quận 1',    city: 'TP.HCM'  },
    { id: 6, name: 'Sân Cầu Lông Celadon City',   address: '36 Đặng Văn Bi, Thủ Đức',            district: 'Thủ Đức',   city: 'TP.HCM'  },
    { id: 7, name: 'Sân Cầu Lông Hoàng Long',     address: '45 Lê Văn Lương, Hải Châu',          district: 'Hải Châu',  city: 'Đà Nẵng' },
  ],
  matches: [],
  participants: [],
  nextUserId: 1,
