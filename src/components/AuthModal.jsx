...
export default function AuthModal({ onClose, defaultTab = 'login' }) {
  ...
  async function handleSocial(provider) {
    ...
    try {
      ...
      setSuccess(`Đăng nhập với ${provider} thành công! Chào mừng ${u.full_name}!`);
          ...
          {!isRegister && (
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '18px 0 12px' }}>
                ...
                <span style={{ fontSize: '0.76rem', color: 'var(--text-muted)', fontWeight: 500 }}>hoặc đăng nhập nhanh</span>
                <div style={{ flex: 1, height: 1, background: 'var(--border-color)' }} />
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <button
                  ...
                  style={{
                    ...
                    background: '#FFFFFF', color: '#1E293B', fontSize: '0.85rem', fontWeight: 600,
                ...
                <button
                  type="button"
                  onClick={() => handleSocial('Zalo')}
                  style={{
                    width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10,
                    padding: '9px 16px', borderRadius: 8, border: 'none',
                    background: '#0068FF', color: '#FFFFFF', fontSize: '0.85rem', fontWeight: 600,
                    cursor: 'pointer', boxShadow: '0 1px 3px rgba(0,104,255,0.3)'
                  }}
                >
                  <span style={{ fontWeight: 900, fontSize: '0.9rem', background: '#FFFFFF', color: '#0068FF', padding: '1px 5px', borderRadius: 4 }}>Z</span>
